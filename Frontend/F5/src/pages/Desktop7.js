  ...
  return (
    <div className="desktop-7">
      <div className="desktop-2">
        ...
        <img className="desktop-2-child4" alt="" src="../ellipse-1@2x.png" />
        ...
        <img className="desktop-2-child9" alt="" src="../ellipse-1@2x.png" />
        <img className="desktop-2-child10" alt="" src="../ellipse-8@2x.png" />
        <img className="desktop-2-child11" alt="" src="../ellipse-8@2x.png" />
        <img className="desktop-2-child12" alt="" src="../ellipse-8@2x.png" />
        <img className="desktop-2-child13" alt="" src="../ellipse-1@2x.png" />
        ...
        <div className="lucknow1">Lucknow</div>
        <div className="lucknow2">Lucknow</div>
        <div className="lucknow3">Lucknow</div>
        <div className="lucknow4">Lucknow</div>
        <div className="lucknow5">Lucknow</div>
        <div className="lucknow6">Lucknow</div>
        <div className="lucknow7">Lucknow</div>
        <div className="lucknow8">Lucknow</div>
        <div className="lucknow9">Lucknow</div>
        <div className="lucknow10">Lucknow</div>
        <div className="lucknow11">Lucknow</div>
        <img
      ...
      <div className="desktop-3">
        <div className="about-hostel-hopper">About Hostel Hopper</div>
        <div className="desktop-3-child" />
        <div className="we-at-hostel">
        ...
        <b className="yashu-mittal">Yashu Mittal</b>
        <i className="chief-executing-officer">Chief Executing Officer</i>
        <b className="yashu-mittal1">Yashu Mittal</b>
        <b className="yashu-mittal2">Yashu Mittal</b>
        <b className="yashu-mittal3">Yashu Mittal</b>
        <b className="yashu-mittal4">Yashu Mittal</b>
        <i className="chief-executing-officer1">Chief Executing Officer</i>
        <i className="chief-executing-officer2">Chief Executing Officer</i>
        <i className="chief-executing-officer3">Chief Executing Officer</i>
        <i className="chief-executing-officer4">Chief Executing Officer</i>
      </div>
      <div className="desktop-4">
                                                                                      ...
                                                                                      <div className="group-wrapper138">
                                                                                        <div className="group-wrapper138">
                                                                                          <div className="group-wrapper138">
                                                                                            <div className="group-wrapper138">
                                                                                              <div className="group-wrapper138">
                                                                                                <div className="group-wrapper180">
        ...
        <img className="youtube-icon" alt="" src="../youtube@2x.png" />
        <img
        ...
        />
        <img
          className="twitter-black-shape"
          alt=""
          src="../twitter-black-shape@2x.png"
        />
        <img
          className="linkedin-big-logo"
          alt=""
        ...
        <div className="receive-a-call-container">
          <p className="receive-a-call">Receive A Call Back From Our Team!</p>
        </div>
        <div className="desktop-4-item" />
        <div className="desktop-4-child1" />
        <img className="mail-inbox-app" alt="" src="../mail-inbox-app@2x.png" />
        <div className="get-a-call">Get a Call Back</div>
        <div className="supporthostelhopperin">support@hostelhopper.in</div>
        ...
        <div className="award-winning-student-container">
          <p className="receive-a-call">Award Winning Student Experience</p>
        </div>
          ...
          <ul className="locate-about-us-contacts">
            ...
            <li className="about-us">
              <a
                ...
                target="_blank"
              >
                <span className="delhi2">Jaipur</span>
              </a>
            </li>
            <li>
              <a
                ...
                target="_blank"
              >
                <span className="delhi2">Gurgaon</span>
              </a>
            </li>
          </ul>
        </div>
      ...
      <a className="desktop-1">
        <div className="desktop-5">
          ...
          <img className="desktop-5-child1" alt="" src="../ellipse-61.svg" />
          <img className="desktop-5-child2" alt="" src="../ellipse-71.svg" />
          <img className="desktop-5-child3" alt="" src="../ellipse-71.svg" />
          <img className="desktop-5-child4" alt="" src="../ellipse-71.svg" />
